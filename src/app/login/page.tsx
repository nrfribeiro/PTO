      ...
      <div className="w-full max-w-md">
        <div className="rounded-2xl border border-border bg-white p-8 shadow-xl shadow-slate-200/50">
          <div className="mb-8 text-center">
            ...
            <h1 className="text-2xl font-bold text-slate-900">PTO Manager</h1>
            <p className="mt-2 text-sm text-slate-500">
              Sign in to manage employee time off
            </p>
          </div>

          <button
            onClick={() => signIn("google", { callbackUrl: "/dashboard" })}
            className="flex w-full items-center justify-center gap-3 rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm font-medium text-slate-700 shadow-sm transition-all hover:bg-slate-50 hover:shadow-md"
          >
